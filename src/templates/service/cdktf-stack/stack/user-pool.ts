...
export function createUserPool(
 ...
 new Route53Record(scope, 'auth-record', {
  ...
  new SsmParameter(this, 'user-pool-id', {
    name: `/${this.vars.environment}/${this.vars.namespace}-user-service/user-pool-id`,
    type: 'String',
    value: pool.id
  });

  new SsmParameter(this, 'user-pool-id', {
    name: `/${this.vars.environment}/${this.vars.namespace}-user-service/app-client-id`,
    type: 'String',
    value: client.id
  });
  return { client, pool };
