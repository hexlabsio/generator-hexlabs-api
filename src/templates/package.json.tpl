{
  ...
  "scripts": {
    ...
    "format:lint": "eslint src/**.ts src/**/*.ts --fix",<% if(databaseTechnology === 'DynamoDB') { %>
    "pretest": "npx tsx ./jest-setup.ts",<% } %>
  ...
  "dependencies": {
    ...
    "@hexlabs/invoker": "^1",
    "@hexlabs/lambda-api-ts": "^0",<% if(httpLibrary === 'hexlabs') { %>
    "@hexlabs/http-api-ts": "^2",<% } %><% if(httpLibrary === 'middy') { %>
    "@middy/core": "^5.5.1",
